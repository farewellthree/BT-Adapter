...
from bt_adapter.eval.model_utils import initialize_model, load_video
from bt_adapter.inference import video_conversation_infer
...
def parse_args():
    ...
    parser.add_argument("--btadapter_weight", type=str, required=False, default=None)
...
def run_inference(args):
    ...
    for sample in tqdm(gt_contents):
        ...
        try:
            ...
            output = video_conversation_infer(video_frames, question, conv_mode, model, vision_tower,
