...
# model settings
num_frames = 16
classes = '/Path/to/your/kinetics400/class_name.txt'
model = dict(
...
data_root = '/Path/to/your/kinetics400/train_data/'
data_root_val = '/Path/to/your/kinetics400/val_data/'
ann_file_train = '/Path/to/your/kinetics400_train_list_videos.txt'
ann_file_val = '/Path/to/your/kinetics400_val_list_videos.txt'
ann_file_test = '/Path/to/your/kinetics400_val_list_videos.txt'
